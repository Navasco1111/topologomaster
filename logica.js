...
function showQuestion(questionObj) {
    ...
    title.innerHTML = "Conjuntos: "+ (currentQuestion + 1) + "/" + questions.length;
...
document.getElementById("next-question-btn").addEventListener("click", () => {    
    ...
    if (currentQuestion + 1 == questions.length){ 
        document.getElementById("question-area").innerHTML = "<h2>¡Fin del cuestionario!</h2><br><h3>Has acertado "+number_correct_questions+" de "+questions.length+" preguntas.</h3>";
